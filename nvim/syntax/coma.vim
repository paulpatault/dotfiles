...
syn keyword comaKeyword     fun let type as by with rec constant inductive
syn keyword comaKeyword     exists forall lemma axiom goal predicate function
syn keyword comaKeyword     module end
